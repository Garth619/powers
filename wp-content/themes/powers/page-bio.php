...
<section class="inner_main">
	...
	<h1 class="centered">Meet Our Attorney</h1>
	...
	<div class="our_attorney_wrapper">
		...
		<div class="our_attorney_inner_wrapper">
			...
			<div class="our_attorney_image">
				...
				<img src="<?php bloginfo('template_directory');?>/images/profile-powers.jpg"/>
			
			</div><!-- our_attorney_image -->
		
			<div class="our_attorney_content">
			
				<span class="attorney_title">Attorney Jessica Powers</span><!-- attorney_title -->
