...
jQuery('.main_header_wrapper .sub_header').queue(function(){

	jQuery(this).addClass('title_fadein').clearQueue();

});



jQuery('.main_header_wrapper .large_header').queue(function(){

	jQuery(this).addClass('letter_fade').clearQueue();

});



jQuery('.white_line').queue(function(){

	jQuery(this).addClass('white_line_fadein').clearQueue();
...
jQuery('.tagline_single_word').queue(function(){

	jQuery(this).addClass('tagline_fadein').clearQueue();

});


jQuery('.green_dot').queue(function(){

	jQuery(this).addClass('green_dot_fade').clearQueue();

});


jQuery('a.request').queue(function(){

	jQuery(this).addClass('request_fadein').clearQueue();
